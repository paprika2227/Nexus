...
- Any illegal activities using the Bot
...
- See exactly how the Bot works

## Privacy

Your use of the Bot is also governed by our Privacy Policy. By using the Bot, you consent to our data practices as described in the Privacy Policy.
